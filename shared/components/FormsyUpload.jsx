...
let FormsyUpload = React.createClass({
    ...
    getDefaultProps: function() {
        ...
        return {
            ...
            name: 'file',
            server: '/api/v1/els/storage/upload'
        }
    },
    ...
    render: function () {
        ...
        val = val ? val.replace(/^(.{3}).*(.{2})\.(.*)$/, '$1..$2.$3') : val;
        // 可以用自定义的children替换默认FlatButton，但id值必须与传入的id属性一致
        return (
            <div style={{display: 'inline-block'}}>
                ...
                {this.state.uploading ?
                    <CircularProgress size={0.3} style={{margin: '-10px',verticalAlign:'middle'}} />
                    : val
                }
            </div>
        );
